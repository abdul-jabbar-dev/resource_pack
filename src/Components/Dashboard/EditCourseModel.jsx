...
const EditCourseModel = ({ item, deleteMutation, }) => {
                            ...
                            <div className="p-4 sm:p-10 text-center overflow-y-auto">
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            <img width={300} height={300} src={"http://localhost:4000/" + item.thumbnail} alt="" />
                                            <input multiple={false} {...register("thumbnail")} name="thumbnail" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" id="thumbnail" type="file" />
                                        </div>

                                    </div>
                                    <div className="mt-6 flex justify-center gap-x-4">
                                        <button type="submit" className="py-2.5 px-4 inline-flex justify-center items-center gap-2 rounded-md border font-medium bg-red-600 text-white shadow-sm align-middle hover:bg-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-red focus:ring-red-600 transition-all text-sm">Submit</button>
